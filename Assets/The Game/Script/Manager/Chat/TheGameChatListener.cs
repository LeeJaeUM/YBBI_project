...
public class TheGameChatListener : MonoBehaviour
{
    private DatabaseReference _chatRef;
    public TheGameChatUIController _chatUIController;
    ...
    {
        string sessionID = await LobbyAndSesssionFireBaseManager.Instance.GetSessionIdByJoinCode(LobbyAndSesssionUIManager.Instance.GetSavedJoinCode());
        Debug.Log(sessionID);
